...
#    args = parse_args()
    ...
    writer = SummaryWriter(filename_suffix='CyclicLR') if args.tensorboard else None
...
#    for param in model.vgg[0][0:20].parameters():
#        param.require_grad = False
#        
#    for param in model.vgg[0][21:35].parameters():
#        param.require_grad = True
