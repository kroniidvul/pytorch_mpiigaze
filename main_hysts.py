...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 29 17:54:29 2019
...
def parse_args():
    ...
    parser.add_argument(
        '--arch', type=str, required=True, choices=['lenet', 'resnet_preact', 'vgg19'])
    ...
    parser.add_argument('--milestones', type=str, default='[15, 20, 35]')
