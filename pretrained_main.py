# -*- coding: utf-8 -*-
"""
Created on Thu Aug  1 15:29:11 2019
...
def parse_args():
    ...
    parser.add_argument(
        '--arch', type=str, required=True, choices=['lenet', 'resnet_preact', 'alexnet'])
...
#        input_cat = torch.cat(images, poses, dim=1)
...
#            outputs = model(images)
    ...
    return angle_error_meter.avg, poses
...
def main():
    ...
    model.classifier = nn.Sequential(nn.Linear(256 * 6 * 6, 500),
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        angle_error = test(epoch, model, criterion, test_loader)
