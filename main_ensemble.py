...
def parse_args():
    ...
    parser.add_argument(
        '--arch', type=str, required=True, choices=['lenet', 'resnet_preact', 'vgg16', 'vgg19', 'resnet50', 'inception', 'ensemble'])
    ...
    parser.add_argument('--milestones', type=str, default='[20, 25]')
