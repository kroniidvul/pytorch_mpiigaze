...
def parse_args():
    ...
    parser.add_argument(
        '--arch', type=str, required=True, choices=['lenet', 'resnet_preact', 'vgg16', 'vgg19', 'resnet50', 'inception', 'ensemble', 'enc_msk'])
...
#    args = parse_args()
    ...
    upsampling = module.Upsampling()
    posnet = module.PosNet()
    imnet = module.ImNet()
        
#    model = module.Model()
    model = module.Ensemble(imnet, posnet)
    model.cuda()
